...
class BSRoformer(Module):
    ...
    def forward(
        ...
        x = self.band_split(x)
        #print(f"After Band Split x shape: {x.shape}")
        ...
        for time_transformer, freq_transformer in self.layers:
            ...
            #print(f"After Time Transformer x shape: {x.shape}")
            ...
            #print(f"After Freq Transformer x shape: {x.shape}")
        ...
        #print(f"After Mask Estimation mask shape: {mask.shape}")
        ...
        #print(f"After Modulation stft_repr shape: {stft_repr.shape}")
        ...
        #print(f"After Reconstruction recon_audio shape: {recon_audio.shape}")
